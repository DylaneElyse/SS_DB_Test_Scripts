...
trg_handle_insert_on_run_results AFTER INSERT OR UPDATE ON ss_run_results FOR EACH ROW EXECUTE FUNCTION handle_insert_on_run_results();
    ...
    CREATE TRIGGER trg_handle_insert_on_heat_judges
AFTER INSERT ON public.ss_heat_judges
FOR EACH ROW
EXECUTE FUNCTION public.handle_new_heat_judge_assignment();